...
public class SQLParser extends Parser {
	...
	public static final int
		RULE_parse = 0, RULE_sql_stmt_list = 1, RULE_sql_stmt = 2, RULE_transaction_stmt = 3, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"parse", "sql_stmt_list", "sql_stmt", "transaction_stmt", "commit_stmt", 
	...
	public final Transaction_stmtContext transaction_stmt() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_transaction_stmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(139);
